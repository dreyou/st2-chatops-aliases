...
# ChatOps & Ansible st2 pack (Dreyou Fork)
...
Original pack and complete Vagrant demo, see [showcase-ansible-chatops](https://github.com/armab/showcase-ansible-chatops) repo.
